...
namespace Project1
{
    public class Mission2 : GameState
    {
        ...
        public Mission2(ContentManager content, SpriteBatch spriteBatch, GraphicsDeviceManager graphics)
        {
            con = content;
        ...
        public void Pre()
        {
            ...
            flag = new BackgroundBuilder(con.Load<Texture2D>("red_flag")).SetPos(new Vector2(6500, 6500))
                .SetWidth(300).SetHeight(300).SetOpacity(0.6f).Build();
            flag.org = new Vector2(flag.texture.Width / 2f, flag.texture.Height / 2f);
        ...
        public void Reset()
        {
            ...
            text = con.Load<Texture2D>("planes/plane3");
            Sprite tmp = new EnemyBoss2(text, new Vector2(-6800, -7400), 300, 300, 0, 0, 0, 0, 250);
            tmp.vel = 1;
            sprites.Add(tmp);

            hlBar = new HealthBar((EnemyBoss2)tmp);
            sprites.Add(hlBar);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Globals.enemyCnt < 30 && Main.cnt == 0 && cnt2 % 120 == 0)
            {
                ...
                Texture2D text = con.Load<Texture2D>("planes/plane4");
                ...
                Sprite sp = new Enemy2(text, pos , 100, 100, 0, 0, 0, 0);
